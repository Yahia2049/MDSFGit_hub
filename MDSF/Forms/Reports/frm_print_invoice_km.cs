...
namespace MDSF.Forms.Reports
{
    public partial class frm_print_invoice_km : Form
    {
        ...
        public frm_print_invoice_km(string region_id, string sales_ter, string salesrep_id, string from_date, string to_date, string salesrep_name, string van_id,string plate_num,string current_date)
        {
            InitializeComponent();
