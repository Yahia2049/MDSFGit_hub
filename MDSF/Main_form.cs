...
namespace MDSF
{
    public partial class Main_form : Form
    {
        ...
        private void pOSMAssigningToolStripMenuItem_Click(object sender, EventArgs e)
        {
            this.Cursor = Cursors.WaitCursor;
            try
            {
                ...
                //if (check != "0")
                //{
                    var X_Form = new frm_POSM_Assign();
                    X_Form.Show();
                    X_Form.MdiParent = this;
                    // X_Form.WindowState = FormWindowState.Maximized;
                //}
        ...
        private void targeyDetailsToolStripMenuItem_Click(object sender, EventArgs e)
        {
            this.Cursor = Cursors.WaitCursor;
            try
            {
                ...
                //if (check != "0")
                //{
                var X_Form = new frm_target_details();
                X_Form.Show();
                X_Form.MdiParent = this;
                // X_Form.WindowState = FormWindowState.Maximized;
                //}
